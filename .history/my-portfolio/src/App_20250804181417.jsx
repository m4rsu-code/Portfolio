  ...
  return (
    <div className='min-h-screen bg-[#1A252F]'>
      ...
      <div className='w-full px-60 py-10'>
        ...
        {/* Contact section */}
        <div className="flex flex-col items-center justify-center mt-20 px-8 py-16 font-jetbrains-mono text-white bg-[#131A26]">
          <div className="flex flex-col md:flex-row items-center justify-center gap-16 max-w-6xl w-full">
            
            {/* Left side — the outlined box */}
            <div className="border border-[#00FFCC] w-[300px] h-[200px] md:w-[400px] md:h-[250px] rounded-md"></div>

            {/* Right side — text, button, and icons */}
            <div className="text-center md:text-left">
              <h2 className="text-[#00FFCC] text-2xl md:text-3xl font-bold mb-6">Get in Touch</h2>
              <p className="text-[#A0AEC0] text-sm md:text-base mb-8 max-w-md">
                I’m open to new opportunities and always happy to connect. Feel free to reach out — I’ll do my best to respond promptly!
              </p>
              <button className="border border-[#00FFCC] text-[#00FFCC] px-6 py-2 rounded hover:bg-[#00FFCC] hover:text-[#131A26] transition duration-300 mb-8">
                Say Hello
              </button>

              {/* Social icons */}
              <div className="flex items-center justify-center md:justify-start gap-4 text-[#A0AEC0]">
