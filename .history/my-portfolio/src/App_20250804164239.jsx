...
function App() {
  ...
  // Figma Projects array with manually defined images and Figma links
  const figmaProjects = [
    {
      id: 1,
        ...
        <container className="flex flex-col mt-30 px-8 py-16 font-jetbrains-mono">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {figmaProjects.map((project) => (
              <div
                key={project.id}
                className="bg-[#1B2A3A] rounded-lg p-4 flex flex-col h-96 w-64 relative group shadow-xs shadow-[#4CD2BC] cursor-pointer transform transition-transform duration-300 ease-in-out hover:-translate-y-2"
              >
                ...
                {/* Image with Fixed Size and Border */}
                <div className="flex-grow flex items-center justify-center p-2">
                  <div className="border border-[#4CD2BC] rounded-md w-[200px] h-[280px] overflow-hidden">
                    <img
                      src={project.image}
