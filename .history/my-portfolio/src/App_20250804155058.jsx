            ...
            {projects.slice(0, 6).map((project) => (
              ...
              >
                ...
                <div className="flex justify-end gap-2">
                  <img src="/Images/github.png" alt="GitHub Icon" className="w-4 h-4 group-hover:icon-tint" />
                  {project.title === 'Portfolio' && project.link && (
                    <a href={project.link} target="_blank" rel="noopener noreferrer">
                      <img src="/Images/link.png" alt="Link Icon" className="w-4 h-4 group-hover:icon-tint" />
                    </a>
                  )}
                </div>
              </div>
