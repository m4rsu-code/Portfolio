...
function App() {
  ...
  // New Figma Projects array with manually defined images and Figma links
  const figmaProjects = [
    {
      id: 1,
      title: 'Portfolio Design',
      image: '/Images/figma1.png',
      figmaLink: 'https://www.figma.com/file/your-portfolio-design-link',
    },
    {
      id: 2,
      title: 'Ttracker UI',
      image: '/Images/figma2.png',
      figmaLink: 'https://www.figma.com/file/your-ttracker-ui-link',
    },
    {
      id: 3,
      title: 'd.resort Prototype',
      image: '/Images/figma3.png',
      figmaLink: 'https://www.figma.com/file/your-dresort-prototype-link',
    },
    {
      id: 4,
      title: 'Fithub Mockup',
      image: '/Images/figma4.png',
      figmaLink: 'https://www.figma.com/file/your-fithub-mockup-link',
    },
    {
      id: 5,
      title: 'da-pizza Design',
      image: '/Images/figma5.png',
      figmaLink: 'https://www.figma.com/file/your-dapizza-design-link',
    },
    {
      id: 6,
      title: 'AlphaSign UI',
      image: '/Images/figma6.png',
      figmaLink: 'https://www.figma.com/file/your-alphasign-ui-link',
    },
  ];
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="flex flex-col h-64">
                ...
                <p className="text-[#4CD2

BC] text-sm mt-2">Date: {achievements[0].date}</p>
              </div>
            </div>
                  ...
                  {project.githubLink ? (
                    <a href={project.githubLink} target="_blank" rel="noopener noreferrer" aria-label={`View ${project.title} on GitHub`}>
                      <img
                        ...
                        alt="GitHub Icon"
                        className="w-4 h-4 hover:in DAGGERvert hover:brightness-0 hover:sepia hover:saturate-[100%]"
                      />
                    </a>
                  ) : (
                    <img
        ...
        <container className="flex flex-col mt-30 px-8 py-16 font-jetbrains-mono">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {figmaProjects.map((project) => (
              <div
                key={project.id}
                className="bg-[#1B2A3A] rounded-lg p-4 flex flex-col h-80 relative group shadow-xs shadow-[#4CD2BC] cursor-pointer transform transition-transform duration-300 ease-in-out hover:-translate-y-2"
              >
                ...
                <div className="flex-grow flex items-center justify-center p-2">
                  <div className="border border-[#4CD2BC] rounded-md w-full h-full overflow-hidden">
                    <img
                      src={project.image}
