...
function App() {
  ...
  const projects = [
    { id: 1, title: 'Portfolio', description: 'This is my portfolio' },
    ...
    { id: 7, title: 'Hubit-web', description: 'This is the web version, designed to complement the app.' },
  ];
  ...
  console.log('Rendering App with achievements:', achievements); // Debug log
