...
function App() {
  ...
  return (
    <div className='min-h-screen bg-[#1A252F]'>
      ...
      <div className='w-full px-60 py-10'>
        ...
        <div className="flex flex-col mt-30 px-8 py-16 font-jetbrains-mono">
          <div className="flex  items-center justify-center w-full">
            ...
            <div className="border border-[#4CD2BC] md:w-[800px] md:h-[250px] rounded-md"></div>
            ...
            <div className="w-full text-center ">
              ...
              <button className="border border-[#00FFCC] text-[#00FFCC] px-6 py-2 rounded hover:bg-[#00FFCC] hover:text-[#131A26] transition duration-300 mb-8 cursor-pointer">
                Say Hello
              </button>
      ...
      {/* Footer */}
      <footer className="text-[#4CD2BC] text-sm flex items-center p-4 justify-between px-6 relative">
        <span className="flex items-center">
          <span className="border-t-2 border-[#4CD2BC] w-20 mr-2 flex items-center"></span>
          Designed & built by Martian L. Rebote
          <img src="Images/code.png" alt="" className='w-4 h-4'/>
        </span>
        <a href="mailto:rebotemartian75@gmail.com" className="text-[#4CD2BC] hover:underline flex items-center">
          rebotemartian75@gmail.com
          <span className="border-t-2 border-[#4CD2BC] w-4 ml-2"></span>
        </a>
      </footer>
    </div>
  );
