  ...
  return (
    <div className='min-h-screen bg-[#1A252F]'>
      ...
      <div className='w-full px-60 py-10'>
        ...
        {/* Footer */}
        <footer className="text-center text-[#4CD2BC] text-sm py-4">
          <p>&copy; {new Date().getFullYear()} Martian L. Rebote. All rights reserved.</p>
          <p className="mt-2">Built with React and love.</p>
          <p className="mt-2">Follow me on <a href="
        </footer>
