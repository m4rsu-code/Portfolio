...
function App() {
  ...
  return (
    <div className='min-h-screen bg-[#1A252F]'>
      ...
      {/* Footer */}
<footer className="text-[#4CD2BC] text-sm flex flex-col items-center p-4 px-6 relative font-jetbrains-mono">
  ...
  <a
    ...
    className="text-[#4CD2BC] hover:underline flex items-center"
  >
