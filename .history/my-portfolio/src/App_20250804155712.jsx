...
function App() {
  ...
  const projects = [
    ...
    { id: 2, title: 'Ttracker', description: 'This is a document tracking system called Ttracker I built during my internship. It handles ordinances, resolutions, and motions, with upload and download features.' },
            ...
            {projects.slice(0, 6).map((project) => (
              ...
              >
                ...
                <div className="flex justify-end gap-2">
                  <img src="/Images/github.png" alt="GitHub Icon" className="w-4 h-4 hover:invert hover:brightness-0 hover:sepia hover:hue-rotate-[120deg] hover:saturate-[1000%]" />
                  {project.title === 'Portfolio' && project.link && (
                    <a href={project.link} target="_blank" rel="noopener noreferrer">
                      <img src="/Images/link.png" alt="Link Icon" className="w-4 h-4 hover:invert hover:brightness-0 hover:sepia hover:hue-rotate-[120deg] hover:saturate-[500%]" />
                    </a>
                  )}
                </div>
              </div>
