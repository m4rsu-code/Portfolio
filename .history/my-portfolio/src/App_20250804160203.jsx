...
function App() {
  ...
  const projects = [
    { id: 1, title: 'Portfolio', description: 'This is my portfolio', link: 'https://your-portfolio.com' },
    { id: 2, title: 'Ttracker', description: 'This is a document tracking system called Ttracker I built during my internship. It handles ordinances, resolutions, and motions, with upload and download features.', githubLink: 'https://github.com/m4rsu-code/Ttracker/tree/main' },
    { id: 3, title: 'd.resort', description: 'This is our capstone project — an IoT-based employee management system with a fingerprint scanner for attendance tracking and salary computation. It also includes a booking system managed by employees.' },
    { id: 4, title: 'Fithub', description: 'This is a fitness website that i make during my 2nd year in college' },
    { id: 5, title: 'da-pizza', description: 'This is my project and im still learning how to code that time' },
    { id: 6, title: 'AlphaSign', description: 'This is the first mobile app project that i built (this is just a simple app)' },
    { id: 7, title: 'Hubit-mobile', description: 'Hubit is a simple fitness app we built quickly for our mobile development course, focusing on core features.' },
    { id: 8, title: 'Hubit-web', description: 'This is the web version, designed to complement the app.' },
  ];
            ...
            {projects.slice(0, 6).map((project) => (
              ...
              >
                ...
                <div className="flex justify-end gap-2">
                  <img src="/Images/github.png" alt="GitHub Icon" className="w-4 h-4 hover:invert hover:brightness-0 hover:sepia hover:saturate-[100%]" />
                  {project.title === 'Portfolio' && project.link && (
                    <a href={project.link} target="_blank" rel="noopener noreferrer">
                      <img src="/Images/link.png" alt="Link Icon" className="w-4 h-4 hover:invert hover:brightness-0 hover:sepia hover:saturate-[100%]" />
                    </a>
                  )}
                </div>
              </div>
