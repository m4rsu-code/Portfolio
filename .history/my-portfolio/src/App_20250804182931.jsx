  ...
  return (
    <div className='min-h-screen bg-[#1A252F]'>
      ...
      <div className='w-full px-60 py-10'>
        ...
        {/* Footer */}
        <footer className="bg-[#131A26] text-[#4CD2BC] text-sm py-4 flex items-center justify-between px-6">
          <span>Designed & built by Martian L. Rebote :)</span>
          <a href="mailto:rebotemartian75@gmail.com" className="text-[#4CD2BC] hover:underline">
