...
import { achievements, projects, figmaProjects, skills, socialMedia } from './assets/components/data';
...
function App() {
  ...
  useEffect(() => {
    setIsLoading(true); // Trigger loader on route change
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className='w-full px-60 py-10'>
                      ...
                      {skills.map((skill, index) => (
                        <div key={index} className='flex flex-col'>
                          <div className='flex justify-between items-center'>
                            <span className='text-[#4CD2BC] text-[15px]'>{skill.name}</span>
                            <span className='text-[#4CD2BC] text-[12px]'>{skill.proficiency}%</span>
                          </div>
                          <div className='w-full bg-[#1B2A3A] rounded-full h-2 mt-1'>
                            <div
                              className='bg-[#00FFCC] h-1 rounded-full transition-all duration-500'
            ...
            {/* Contact Section */}
            <div id='contact' className="flex flex-col mt-30 px-8 py-16 font-jetbrains-mono">
              <div className="flex items-center justify-center w-full">
                <div className="md:w-[980px] md:h-[250px] rounded-md text-center">
                  <h1 className='text-[110px] text-shadow-cyan-50 font-extrabold text-[#FF38E5] cursor-pointer'>m4rsu</h1>
                    ...
                    {socialMedia.map((social, index) => (
                      ...
                      >
                        <img
                          ...
                          className="w-6 h-6 hover:invert hover:brightness-0 hover:sepia hover:saturate-[100%]"
                        />
                      </a>
                    ))}
                  </div>
                ...
                <div className="w-full text-center mt-5">
                  ...
                  <button
                    ...
                    className="border border-[#00FFCC] text-[#00FFCC] px-6 py-2 rounded hover:bg-[#00FFCC] hover:text-[#131A26] transition duration-300 mb-8 cursor-pointer"
                  >
                    Say Hello
                  </button>
                </div>
